    ...
    public class ChartViewController : Controller
    {
        ...
        public JsonResult DashBoardcount(string getPatchValue)
        {
            try
            {
                ...
                cnn.Open();
                SqlCommand cmd = new("SELECT count (root) as DACH,(SELECT count (root) FROM JsonDataSectraUseThis WHERE root = 'UK' AND programpatch = '" + Patch + "') as UK,(SELECT count (root) FROM JsonDataSectraUseThis WHERE root = 'NA' AND programpatch = '" + Patch + "') as NA,(SELECT count (root) FROM JsonDataSectraUseThis WHERE root = 'Southeast_Imaging' AND programpatch = '" + Patch + "') as Southeast_Imaging,(SELECT count (root) FROM JsonDataSectraUseThis WHERE root = 'Commit' AND programpatch = '" + Patch + "') as Commït,(SELECT count (root) FROM JsonDataSectraUseThis WHERE root = 'Benelux' AND programpatch = '" + Patch + "') as Benelux,(SELECT count (root) FROM JsonDataSectraUseThis WHERE root = 'Scandinavia' AND programpatch = '" + Patch + "') as Scandinavia,(SELECT count (root) FROM JsonDataSectraUseThis WHERE root = 'Iberia' AND programpatch = '" + Patch + "') as Iberia,(SELECT count (root) FROM JsonDataSectraUseThis WHERE root = 'PhilipsDACH' AND programpatch = '" + Patch + "') as PhilipsDACH,(SELECT count (root) FROM JsonDataSectraUseThis WHERE root = 'Medi-Far' AND programpatch = '" + Patch + "') as MediFar,(SELECT count (root) FROM JsonDataSectraUseThis WHERE root = 'ANZ' AND programpatch = '" + Patch + "') as ANZ,(SELECT count (root) FROM JsonDataSectraUseThis WHERE root = 'MedIT' AND programpatch = '" + Patch + "') as Medit,(SELECT count (root) FROM JsonDataSectraUseThis WHERE root = 'France' AND programpatch = '" + Patch + "') as France,(SELECT count (root) FROM JsonDataSectraUseThis WHERE root = 'SouthAfrica' AND programpatch = '" + Patch + "') as SouthAfrica,(SELECT count (root) FROM JsonDataSectraUseThis WHERE root = 'Preop Online' AND programpatch = '" + Patch + "') as PreopOnline,(SELECT count (root) FROM JsonDataSectraUseThis WHERE root = 'AttirhMedico' AND programpatch = '" + Patch + "') as AttiehMedico,(SELECT count (root) FROM JsonDataSectraUseThis WHERE root = 'Answer_Medical' AND programpatch = '" + Patch + "') as Answer_Medical,(SELECT count (root) FROM JsonDataSectraUseThis WHERE root = 'Education' AND programpatch = '" + Patch + "'),(SELECT count (root) FROM JsonDataSectraUseThis WHERE root = 'Preop Online' AND programpatch = '" + Patch + "') as Education FROM RealTable WHERE root = 'DACH' AND programpatch = '" + Patch + "'", cnn);
                DataTable dt = new();
                ...
                {
                    dashBoardcount[0] = dt.Rows[0]["DACH"].ToString();
                    dashBoardcount[1] = dt.Rows[0]["UK"].ToString();
